...
export async function POST(req: Request) {
    ...
    try {
        ...
        const {name, contact, email,state,district,exam,gender,dateOfBirth } = body;
        const University = new examModelData({
            name, contact, email,state,district,exam,gender,dateOfBirth
          });
